 ...
 * 更换柜子
 */
public class ReplaceCabinetActivity extends BaseActivityOld<ReplaceDevicePresenterOid> {
    ...
    void changeBtnState() {
        String deviceCode = tvDeviceCode.getText().toString().trim();
        String remark = etRemark.getText().toString().trim();
        boolean enable = !TextUtils.isEmpty(deviceCode) && !TextUtils.isEmpty(remark);
