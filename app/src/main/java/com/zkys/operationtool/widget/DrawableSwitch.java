...
public class DrawableSwitch extends View
{
	...
	{
		Log.d(this.getClass().getSimpleName(),"init(),  isSwitchOn=" + isSwitchOn);
	...
	{
		Log.d(this.getClass().getSimpleName(),"changeStatus...");
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec)
	{
		...
		Log.d(this.getClass().getSimpleName(),"onMeasure(),width=" + width + ",height=" + height);
	...
	protected void onDraw(Canvas canvas)
	{
		...
		Log.d(this.getClass().getSimpleName(),"onDraw(),  isSwitchOn=" + isSwitchOn);
