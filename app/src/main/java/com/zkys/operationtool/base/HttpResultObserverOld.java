 ...
 */
@Deprecated
public abstract class HttpResultObserverOld<T> implements Observer<HttpResponseOld<T>> {
    @Override
    ...
    @Override
    public void onNext(HttpResponseOld<T> result) {
    ...
    public abstract void onSuccess(HttpResponseOld<T> result);
